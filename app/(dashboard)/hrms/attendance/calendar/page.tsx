...
import { ChevronLeft, ChevronRight, Clock, RotateCcw, X, AlertCircle } from "lucide-react";
...
export default function AttendanceCalendarPage() {
  ...
  // Build grid: pad leading empty cells
            ...
            {!selectedDay.isWeekend && !selectedDay.isHoliday &&
              ...
              <div className="border-t border-slate-200 p-4">
                <button
                  onClick={() => {
                    setSelectedDay(null);
                    router.push(`/hrms/attendance/regularization?date=${selectedDay.date}&attendanceId=${selectedDay.attendance?.id ?? ""}&currentStatus=${selectedDay.attendance?.status ?? ""}`);
                  }}
