      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 divide-y sm:divide-y-0 md:divide-x divide-zinc-200 pb-8 border-b border-zinc-200">
        <div className="flex flex-col justify-between pt-2 pb-4 pr-6 md:pl-0 md:pr-6 relative h-36">
          <div className="flex-1">
            <span className="text-sm font-semibold text-zinc-400">My Leads</span>
        ...
        <Link href="/followup/today" className="flex flex-col justify-between pt-2 pb-4 px-6 relative h-36 hover:bg-zinc-50/45 transition-colors">
          <div className="flex-1">
            <span className="text-sm font-semibold text-zinc-400 font-secondary">Today&apos;s Follow-ups</span>
            <div className="text-5xl font-bold text-zinc-900 mt-2 font-secondary tracking-tight">
        ...
        <Link href="/followup/missed" className="flex flex-col justify-between pt-2 pb-4 px-6 relative h-36 hover:bg-zinc-50/45 transition-colors">
          <div className="flex-1">
            <span className="text-sm font-semibold text-zinc-400 font-secondary">Missed Follow-ups</span>
            <div className="text-5xl font-bold text-zinc-900 mt-2 font-secondary tracking-tight">
              {missedCount.isLoading ? "..." : (missedCount.data ?? 0).toString().padStart(2, "0")}
            </div>
          </div>
          <div className="h-1.5 bg-red-600 absolute bottom-0 left-6 right-6" />
        </Link>

        <Link href="/followup/upcoming" className="flex flex-col justify-between pt-2 pb-4 pl-6 pr-0 relative h-36 hover:bg-zinc-50/45 transition-colors">
          <div className="flex-1">
            <span className="text-sm font-semibold text-zinc-400 font-secondary">Upcoming Follow-ups</span>
            <div className="text-5xl font-bold text-zinc-900 mt-2 font-secondary tracking-tight">
              {upcomingCount.isLoading ? "..." : (upcomingCount.data ?? 0).toString().padStart(2, "0")}
            </div>
          </div>
          <div className="h-1.5 bg-amber-400 absolute bottom-0 left-6 right-0" />
        </Link>
      </div>
