...
export function SalesManagerDashboard() {
  ...
  return (
    <div className="space-y-4 font-sans pb-12">
      ...
      {/* ── Split Section 2: Recent Leads, My Team & Quick Actions ── */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 py-8">
        ...
        <div className="flex flex-col min-h-[340px] lg:pl-8 border-t lg:border-t-0 lg:border-l border-zinc-200 pt-8 lg:pt-0">
          ...
          <Link
            href="/my-team"
            className="flex items-center gap-4 rounded-2xl border border-zinc-200/80 p-4 bg-white hover:bg-zinc-50/50 hover:border-zinc-300 transition-all shadow-sm group mb-4"
          >
