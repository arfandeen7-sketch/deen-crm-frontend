...
const MASS_UPDATE_FIELDS: FieldDef[] = [
  ...
  { key: "nationality",    label: "Nationality",     kind: "text",     nullable: true },
  ...
  { key: "unitNumber",     label: "Unit Number",    kind: "text",     nullable: true },
  { key: "buildingNo",     label: "Building No.",    kind: "text",     nullable: true },
