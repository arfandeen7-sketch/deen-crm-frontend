...
import { Pencil, X, Check, CreditCard, UserCircle2, Mail, Phone, Calendar, FileText } from "lucide-react";
...
export function TenantDetailsCard({ leadId }: TenantDetailsCardProps) {
        ...
        {editing ? (
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 gap-x-8 sm:grid-cols-2">
              <InfoRow icon={UserCircle2}  label="Full Name"        value={tenant.fullName} />
              <InfoRow icon={Phone}        label="Mobile Number"    value={tenant.mobileNumber} />
